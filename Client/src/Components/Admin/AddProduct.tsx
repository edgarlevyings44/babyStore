        ...
        <div className="w-3/4 md:w-1/2">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="mt-1">
                    ...
                    <div className="mt-2">
                        <input name="category" value={formData.category} onChange={handleChange} type="name" required className="w-full rounded-md border-2 border-zinc-950 indent-3 text-gray-900 shadow-sm py-1.5"/>
                    </div>
                </div>
